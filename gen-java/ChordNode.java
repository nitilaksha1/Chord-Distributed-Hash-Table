...
public class ChordNode implements org.apache.thrift.TBase<ChordNode, ChordNode._Fields>, java.io.Serializable, Cloneable, Comparable<ChordNode> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ChordNode");
  ...
  private static final org.apache.thrift.protocol.TField PORTNUMBER_FIELD_DESC = new org.apache.thrift.protocol.TField("portnumber", org.apache.thrift.protocol.TType.I32, (short)3);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new ChordNodeStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ChordNodeTupleSchemeFactory());
  }
  ...
  static {
    ...
    tmpMap.put(_Fields.PORTNUMBER, new org.apache.thrift.meta_data.FieldMetaData("portnumber", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ChordNode.class, metaDataMap);
  }
   ...
   */
  public ChordNode(ChordNode other) {
  ...
  public ChordNode setKey(int key) {
    this.key = key;
    setKeyIsSet(true);
    return this;
  }
  ...
  public ChordNode setHostname(String hostname) {
    this.hostname = hostname;
    return this;
  }
  ...
  public ChordNode setPortnumber(int portnumber) {
    this.portnumber = portnumber;
    setPortnumberIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ChordNode)
      return this.equals((ChordNode)that);
    return false;
  }

  public boolean equals(ChordNode that) {
    if (that == null)
      return false;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ChordNode(");
    boolean first = true;
  ...
  private static class ChordNodeStandardSchemeFactory implements SchemeFactory {
    public ChordNodeStandardScheme getScheme() {
      return new ChordNodeStandardScheme();
    }
  }

  private static class ChordNodeStandardScheme extends StandardScheme<ChordNode> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ChordNode struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ChordNode struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      oprot.writeFieldBegin(PORTNUMBER_FIELD_DESC);
  ...
  private static class ChordNodeTupleSchemeFactory implements SchemeFactory {
    public ChordNodeTupleScheme getScheme() {
      return new ChordNodeTupleScheme();
    }
  }

  private static class ChordNodeTupleScheme extends TupleScheme<ChordNode> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ChordNode struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ChordNode struct) throws org.apache.thrift.TException {
